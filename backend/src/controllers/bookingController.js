...
const verifyPayment = async(req,res) =>{
    ...
    if(forceStatus ==="success"){
        ...
        let nights = bookingDetails.numberOfnights || bookingDetails.nights;
        if (!nights && bookingDetails.fromDate && bookingDetails.toDate) {
            nights = Math.round(Math.abs(new Date(bookingDetails.toDate) - new Date(bookingDetails.fromDate)) / (1000 * 60 * 60 * 24));
        }

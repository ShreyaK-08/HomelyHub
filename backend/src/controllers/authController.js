...
const login = async (req, res) => {
  try {
    ...
    if (normalizedEmail === "shreya8225@gmail.com") queryEmails.push("shreyak8225@gmail.com");
    if (normalizedEmail === "shreyak8225@gmail.com") queryEmails.push("shreya8225@gmail.com");
    const user = await User.findOne({ email: { $in: queryEmails } }).select("+password");
